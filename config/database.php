...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Shared cross-service flow-trace store. Both ISSWatch and satellite-demo
        // write their nestedflowtracker spans here, so a request that crosses the
        // two services renders as a single trace tree. Driver-flexible: SQLite for
        // local dev (a file shared by both apps) and MySQL in production (one DB
        // both deployments connect to). Switch via the FLOW_DB_* env vars.
        'flow' => [
